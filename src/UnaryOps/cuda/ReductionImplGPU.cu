...
// float4_e3m1_t (custom datatype)
template Tensor dispatch_reduction_gpu<float4_e2m1_t, SumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_t, ProductOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_t, MinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_t, MaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_t, NanSumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_t, NanProductOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_t, NanMinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_t, NanMaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_t, ArgMinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_t, ArgMaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_t, NanArgMinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_t, NanArgMaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_mean_gpu<float4_e2m1_t, SumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_mean_gpu<float4_e2m1_t, NanSumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_variance_gpu<float4_e2m1_t, VarianceOp>(const Tensor& input, const std::vector<int64_t>& axes, bool keepdim , int64_t correction, cudaStream_t stream);
template Tensor dispatch_variance_gpu<float4_e2m1_t, NanVarianceOp>(const Tensor& input, const std::vector<int64_t>& axes, bool keepdim , int64_t correction, cudaStream_t stream);

// float4_e3m1_2x_t (custom datatype)
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, SumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, ProductOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, MinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, MaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, NanSumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, NanProductOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, NanMinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_reduction_gpu<float4_e2m1_2x_t, NanMaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_2x_t, ArgMinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_2x_t, ArgMaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_2x_t, NanArgMinOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_index_reduction_gpu<float4_e2m1_2x_t, NanArgMaxOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_mean_gpu<float4_e2m1_2x_t, SumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_mean_gpu<float4_e2m1_2x_t, NanSumOp>(const Tensor&, const std::vector<int64_t>&, bool, cudaStream_t);
template Tensor dispatch_variance_gpu<float4_e2m1_2x_t, VarianceOp>(const Tensor& input, const std::vector<int64_t>& axes, bool keepdim , int64_t correction, cudaStream_t stream);
template Tensor dispatch_variance_gpu<float4_e2m1_2x_t, NanVarianceOp>(const Tensor& input, const std::vector<int64_t>& axes, bool keepdim , int64_t correction, cudaStream_t stream);
