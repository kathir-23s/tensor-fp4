...
int main() {
    std::vector<TestCase> cases = {
        ...
        {0b0001, 0.5f, false, false, "0.5 (Subnormal)"}, 
        {0b0010, 1.0f, false, false, "1.0 (Normal)"}, 
        {0b0011, 1.5f, false, false, "1.5 (Normal)"}, 
        {0b0100, 2.0f, false, false, "2.0 (Normal)"}, 
        {0b0101, 3.0f, false, false, "3.0 (Normal)"}, 
        ...
        {0b1001, -0.5f, false, false, "-0.5 (Subnormal)"},
        {0b1010, -1.0f, false, false, "-1.0 (Normal)"},
        {0b1011, -1.5f, false, false, "-1.5 (Normal)"},
        {0b1100, -2.0f, false, false, "-2.0 (Normal)"},
        {0b1101, -3.0f, false, false, "-3.0 (Normal)"},
